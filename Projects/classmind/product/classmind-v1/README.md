...
`.env.local` needs the keys listed in `.env.example`. Set `TRANSCRIPTION_PROVIDER=fixture` to
replay three captured Sarvam responses instead of paying for real calls; leave it unset for live
transcription.
